...
# IDEALIZE PDB AND GET ITS TORSION ANGLE again
...
print "pdb2vall.py: parse_dssp_results(): using the non-idealized pdb to run dssp to get  1.solvent assessbilty  2.dssp_phi  3.dssp_psi ..."
dssp_Dict = parse_dssp_results( options.pdb_fn[:-4]+'.pdb', fasta_dict )
...
if not exists( pdb + "_0001_0001.pdb"):
    ...
    #print idealized_pdb_cenxyz_lines
